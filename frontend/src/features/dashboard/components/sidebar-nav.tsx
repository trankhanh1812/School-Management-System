...
const iconMap: Record<string, (props: IconProps) => ReactElement> = {
  "/dashboard": (props) => (
    <NavIcon
      {...props}
      path="M4 13h7V4H4zm9 7h7V11h-7zm0-16v5h7V4zM4 20h7v-5H4z"
    />
  ),
  "/students": (props) => (
    <NavIcon
      {...props}
      path="M16 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2m18 0v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75M14 7a4 4 0 1 1-8 0a4 4 0 0 1 8 0z"
    />
  ),
  "/teachers": (props) => (
    <NavIcon
      {...props}
      path="M3 7l9-4l9 4l-9 4zM7 10v4c0 1.7 2.2 3 5 3s5-1.3 5-3v-4M21 9v6"
    />
  ),
  "/classes": (props) => (
    <NavIcon {...props} path="M4 5h16v12H4zM8 21h8M12 17v4" />
  ),
  "/subjects": (props) => (
    <NavIcon
      {...props}
      path="M5 4h11a3 3 0 0 1 3 3v13H8a3 3 0 0 0-3 3zm0 0v16a3 3 0 0 1 3-3h11"
    />
  ),
  "/students/conduct": (props) => (
    <NavIcon {...props} path="M4 6h16M7 6v12m10-12v12M6 18h12" />
  ),
  "/teaching-assignments": (props) => (
    <NavIcon
      {...props}
      path="M4 6h6v6H4zm10 0h6v6h-6zM4 16h6v4H4zm10 0h6v4h-6"
    />
  ),
  "/scores": (props) => (
    <NavIcon
  ...
  "/attendance": (props) => (
    <NavIcon {...props} path="M9 11l3 3L22 4M21 12v7H3V5h11" />
  ),
  "/schedule": (props) => (
    <NavIcon
      {...props}
      path="M8 2v4M16 2v4M3 10h18M5 4h14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z"
    />
  ),
  "/reports": (props) => (
    <NavIcon {...props} path="M4 19V5m5 14V9m5 10V13m5 6V7" />
  ),
  "/notifications": (props) => (
    <NavIcon
      {...props}
      path="M15 17h5l-1.4-1.4A2 2 0 0 1 18 14.2V11a6 6 0 1 0-12 0v3.2a2 2 0 0 1-.6 1.4L4 17h5m6 0a3 3 0 1 1-6 0"
    />
  ),
  "/system-settings": (props) => (
    <NavIcon
      {...props}
      path="M12 8a4 4 0 1 0 0 8a4 4 0 0 0 0-8zm8.94 4a7.96 7.96 0 0 0-.18-1.67l2.06-1.6l-2-3.46l-2.5 1a8.1 8.1 0 0 0-2.9-1.67L15 2h-6l-.42 2.6a8.1 8.1 0 0 0-2.9 1.67l-2.5-1l-2 3.46l2.06 1.6A8.2 8.2 0 0 0 3.06 12c0 .57.06 1.12.18 1.67l-2.06 1.6l2 3.46l2.5-1a8.1 8.1 0 0 0 2.9 1.67L9 22h6l.42-2.6a8.1 8.1 0 0 0 2.9-1.67l2.5 1l2-3.46l-2.06-1.6c.12-.55.18-1.1.18-1.67z"
    />
  ),
  ...
  "/my-profile": (props) => (
    <NavIcon
      {...props}
      path="M12 2a4 4 0 1 0 0 8 4 4 0 0 0 0-8zm0 10c-5.3 0-8 2.7-8 6v2h16v-2c0-3.3-2.7-6-8-6z"
    />
  ),
  "/my-scores": (props) => (
    <NavIcon
...
export function SidebarNav({ collapsed = false }: { collapsed?: boolean }) {
  ...
  useEffect(() => {
    ...
    function handleUnreadChange(event: Event) {
      ...
      const count =
        typeof customEvent.detail?.count === "number"
    ...
    <nav className="grid gap-2">
      {links.map((item) => {
        ...
        return (
          ...
          >
            {/* Icon wrapper — relative so the badge can be absolute-positioned */}
