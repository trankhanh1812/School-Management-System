      ...
      <div className="mt-6 grid gap-5 sm:grid-cols-[200px_1fr] sm:items-center">
        <div className="mx-auto grid place-items-center">
          ...
          >
            <div className="absolute inset-[22%] grid place-items-center rounded-full bg-white text-center">
              ...
              <span className="text-xs uppercase tracking-[0.1em] text-slate-500">Tong</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-2">
          {normalized.length === 0 ? (
            ...
            normalized.map((item) => (
              <div key={item.label} className="flex items-center justify-between rounded-xl border border-slate-200 bg-white/70 px-3 py-2 text-sm">
